...
class Blackjack{
    ...
    setSfx(){
        this.sfx.shuffle = document.createElement('audio')
        this.sfx.shuffle.src = '../../sfx/shuffle.mp3'
        
        this.sfx.draw = document.createElement('audio')
        this.sfx.draw.src = '../../sfx/draw.mp3'
    }
